...
const PricingSection = () => {
  ...
  return (
    <section className="pricing-section-home" id="pricing">
      <div className="pricing-container">
        ...
        >
          ...
          <h2 className="section-title">Transparent pricing, flexible plans</h2>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              {plan.isCustom ? (
                ...
                <Link to="/pricing" className="plan-cta-btn">
                  {plan.cta}
                </Link>
              )}
            </motion.div>
